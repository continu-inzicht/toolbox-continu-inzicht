        ...
        if "timeSeries" in json_data:
            ...
            for serie in json_data["timeSeries"]:
                ...
                if len(measuringstation) > 0:
                    measurement_location_id = int(measuringstation["measurement_location_id"].iloc[0])                    
                    measurement_location_description = str(measuringstation["measurement_location_description"].iloc[0])
