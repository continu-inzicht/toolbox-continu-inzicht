...
def main():
    ...
    combine_damlive_results.run(
        ...
        output=[
            ...
            "merge_waternet",
            "merge_calculations",
            "ci_database_damlive_models",
            "ci_database_damlive_scenarios",
            "ci_database_damlive_soil",
            "ci_database_damlive_soil_color",
            "ci_database_damlive_lines",
            "ci_database_damlive_lines_enveloping",
            "ci_database_damlive_values",
            # "ci_database_damlive_conditions",
        ],
    )

    print("DAM-Live resultaten succesvol verwerkt in database.")
    ...
    #     lambda x: (
    #         datetime.datetime.fromisoformat(x).astimezone(tz).strftime("%Y-%m-%dT%H")
    #     )
    # )
