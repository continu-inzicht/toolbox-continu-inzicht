...
Als de fragility curves van tevoren zijn berekend met een bepaalde maatregel, kunnen we de huidige curve vervangen met een voorberekende curve die past bij de maatregel. Deze voorberekende curve komt dan uit een 'cache', in de meeste gevallen is dit een database maar dit kan ook in het geheugen zijn bijvoorbeeld.
Als de curve die past bij de maatregel niet in de cache zit, verschuiven we de originele curve. Hiervoor is ook een koppeling nodig tussen maatregel en effect.
