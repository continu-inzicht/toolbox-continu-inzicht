...
Bij het combineren van de fragility curves moeten de fragility waterstanden van de curves op elkaar afgestemd worden. Dit wordt gedaan op basis van de waterniveaus en nog twee parameters: hoe ver voorbij de hoogste waarde `extend_past_max` (standaardwaarde is 0.01) en met welke stapgrootte `refine_step_size` (standaardwaarde is 0.05)
