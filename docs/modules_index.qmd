...
7.  [Inspectieresultaten inlezen en weergeven](modules/inspectieresultaten.qmd)
    ...
    Naast informatie over huidige belastingen op een dijk is het ook interessant om informatie over de huidige sterke van de dijk te verzamelen. Hierbij spelen inspecties een grote rol, deze kunnen met de toolbox worden gefilterd, geclassificeerd en getoond op de viewer van Continu Inzicht.
