...
|Gewogen gemiddelde|`CombineFragilityCurvesWeightedSum`|$P(fail,comb|h) = SUM(w_i * P(fail,i|h))$   |
...
In het voorbeeld hier onder wordt gebruik gemaakt van`FragilityCurveOvertopping` in de GlobalVariables, ook al wordt de `ShiftFragilityCurveOvertopping` functie aangeroepen.
...
Tekst na uitvoering aan te vullen
...
## Inspectieresultaten inlezen en weergeven {#sec-Resultaten-inlezen}

Tekst na uitvoering aan te vullen


## Resultaten ontsluiten via Digitale Delta API {#sec-Resultaten-ontsluiten}
