...
| Name | Description |
| --- | --- |
| [check_rootdir](#toolbox_continu_inzicht.base.data_adapter.check_rootdir) | Checkt of de rootdir bestaat |
| [get_kwargs](#toolbox_continu_inzicht.base.data_adapter.get_kwargs) | Gegeven een input/output functie, stuurt de relevanten kwargs uit de input config naar de functie. |

### check_rootdir { #toolbox_continu_inzicht.base.data_adapter.check_rootdir }

`base.data_adapter.check_rootdir(global_variables)`

Checkt of de rootdir bestaat

### get_kwargs { #toolbox_continu_inzicht.base.data_adapter.get_kwargs }
