...
1. Grote bestanden? Gebruik hier voor [`git lfs`](https://git-lfs.com/), makkelijkste gang van zaken is om het bestand(sformaat) toe te voegen aan `.gitattributes` in de hoofdmap.
