...
Alle aanpassingen zijn te vinden in pull request [#55](https://github.com/continu-inzicht/toolbox-continu-inzicht/pull/55)

In Sprint 5 is gekeken naar het filteren, ontsluiten en visualiseren van inspectie resultaten.



#### Technische

Om het mogelijk te maken  wordt de opmaak informatie voor kaartlagen nu uit de database opgehaald door de viewer.
