...
Parallel aan de regulieren sprints is ook een traject geweest om GEKB (overloop en golfoverslag van dijken) fragility curves af te kunnen leiden met HR-database (Hydraulische Randvoorwaarde database)
